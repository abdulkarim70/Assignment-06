...
const PricingSection = () => {
  ...
  <div className="max-w-6xl mx-auto text-center">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div className="bg-gray-100 text-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-lg transition">
      ...
      <div className="relative rounded-2xl p-8 bg-gradient-to-br from-purple-600 to-purple-800 text-white scale-100 lg:scale-105 shadow-lg">

        <span className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#FEF3C6] text-black text-sm px-4 py-1 rounded-full font-medium">
          Most Popular
        </span>
